...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("c75d43e2", content, true, context)
};
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("632d015a", content, true, context)
};
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("0f4ae3d2", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(248);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Notification_vue_vue_type_style_index_0_id_07502555_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".use-text-title[data-v-07502555]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-07502555]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-07502555]{font-size:28px;line-height:44px}}.use-text-title2[data-v-07502555]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-07502555]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-07502555]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-07502555]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-07502555]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-07502555]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-07502555]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-07502555]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-07502555]{font-size:16px;line-height:24px}}.use-text-caption[data-v-07502555],.use-text-paragraph[data-v-07502555]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-07502555]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-07502555]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-07502555]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-07502555]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-07502555]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-07502555]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-07502555]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-07502555]{display:none}}.notification[data-v-07502555]{width:95%;margin:0 auto}@media(min-width:1280px){.notification[data-v-07502555]{width:80%}}.notification[data-v-07502555]  .v-snack__wrapper{width:100%;margin-bottom:16px;max-width:none;font-size:16px;color:#fff;background:#424242}@media(min-width:600px){.notification[data-v-07502555]  .v-snack__wrapper{padding:4px 16px}}.notification[data-v-07502555]  .v-snack__wrapper>div:first-child{display:flex;align-items:center}@media(min-width:600px){.notification[data-v-07502555]  .v-snack__wrapper>div:first-child .action{flex:1}[dir=ltr] .notification[data-v-07502555]  .v-snack__wrapper>div:first-child .action{margin-right:16px}[dir=rtl] .notification[data-v-07502555]  .v-snack__wrapper>div:first-child .action{margin-left:16px}}@media(max-width:599px){.notification[data-v-07502555]  .v-snack__wrapper>div:first-child .action{text-align:center}}.notification .button.v-btn[data-v-07502555]{width:100%;box-shadow:none}@media(min-width:600px){.notification .button.v-btn[data-v-07502555]{width:150px}}@media(max-width:599px){.notification .button.v-btn[data-v-07502555]{margin:16px 0}}@media(max-width:599px){.action[data-v-07502555]{width:100%;padding:0;margin:0}}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/Notification/Notification.vue?vue&type=template&id=07502555&scoped=true&
...
// CONCATENATED MODULE: ./components/Notification/Notification.vue?vue&type=template&id=07502555&scoped=true&
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(268);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Faq_vue_vue_type_style_index_0_id_2e7a8825_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".use-text-title[data-v-2e7a8825]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-2e7a8825]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-2e7a8825]{font-size:28px;line-height:44px}}.use-text-title2[data-v-2e7a8825]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-2e7a8825]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-2e7a8825]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-2e7a8825]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-2e7a8825]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-2e7a8825]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-2e7a8825]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-2e7a8825]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-2e7a8825]{font-size:16px;line-height:24px}}.use-text-caption[data-v-2e7a8825],.use-text-paragraph[data-v-2e7a8825]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-2e7a8825]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-2e7a8825]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-2e7a8825]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-2e7a8825]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-2e7a8825]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-2e7a8825]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-2e7a8825]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-2e7a8825]{display:none}}.root[data-v-2e7a8825]{z-index:56}.root[data-v-2e7a8825],.text[data-v-2e7a8825]{position:relative}.text[data-v-2e7a8825]{z-index:20}.illustration[data-v-2e7a8825]{position:relative;margin:48px 48px 0}@media(max-width:1279px){.illustration[data-v-2e7a8825]{display:none}}.illustration>div[data-v-2e7a8825]{top:-240px}.illustration img[data-v-2e7a8825]{display:block;width:280px;z-index:4;position:relative}.accordion[data-v-2e7a8825]{position:relative}.item[data-v-2e7a8825],.paper[data-v-2e7a8825]{margin-bottom:24px}.paper[data-v-2e7a8825]{border-radius:12px!important;overflow:hidden}.theme--dark .paper[data-v-2e7a8825]{box-shadow:0 1px 3px 0 #404040,0 1px 1px 0 #2a2a2a,0 2px 1px -1px #141414}.theme--light .paper[data-v-2e7a8825]{box-shadow:0 1.5px 12px 2px rgba(0,0,0,.06)}.heading[data-v-2e7a8825]{display:block;font-weight:var(--font-medium);padding:8px 16px 8px 0;font-size:18px;line-height:1.5;margin-bottom:0}@media(max-width:599px){.heading[data-v-2e7a8825]{font-size:16px}}.content .icon[data-v-2e7a8825]{position:absolute;top:20px}[dir=ltr] .content .icon[data-v-2e7a8825]{right:16px}[dir=rtl] .content .icon[data-v-2e7a8825]{left:16px}.theme--light .expanded[data-v-2e7a8825]{background:linear-gradient(30deg,var(--v-primary-base),var(--v-secondary-base))}.theme--dark .expanded[data-v-2e7a8825]{background:linear-gradient(30deg,var(--v-primarydark-base),var(--v-secondarydark-base))}.expanded .heading[data-v-2e7a8825]{color:#fff;padding-top:0;padding-bottom:0}.expanded[data-v-2e7a8825]  .v-icon{color:#fff!important;transform:rotate(180deg)}.detail[data-v-2e7a8825]{padding-top:24px;border-radius:0 0 12px 12px}.theme--light .detail[data-v-2e7a8825]{background-color:#fff}.theme--dark .detail[data-v-2e7a8825]{background-color:#424242}.detail span[data-v-2e7a8825]{display:block;font-size:18px}@media(max-width:599px){.detail span[data-v-2e7a8825]{font-size:16px}}.theme--light .icon[data-v-2e7a8825]{color:var(--v-primary-base)}.theme--dark .icon[data-v-2e7a8825]{color:var(--v-primarylight-base)}.deco-primary[data-v-2e7a8825]{width:450px;height:450px;position:absolute;top:-20px;transform:scale(.6)}.theme--light .deco-primary[data-v-2e7a8825]{fill:var(--v-primarylight-base)}.theme--dark .deco-primary[data-v-2e7a8825]{fill:var(--v-secondarydark-base)}[dir=ltr] .deco-primary[data-v-2e7a8825]{left:-110px}[dir=rtl] .deco-primary[data-v-2e7a8825]{right:-110px}.deco-primary .v-application--is-rtl[data-v-2e7a8825]{transform-origin:right center}.deco-primary .v-application--is-ltr[data-v-2e7a8825]{transform-origin:left center}", ""]);
// Exports
module.exports = exports;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(271);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_NewsEvent_vue_vue_type_style_index_0_id_1491096e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".use-text-title[data-v-1491096e]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-1491096e]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-1491096e]{font-size:28px;line-height:44px}}.use-text-title2[data-v-1491096e]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-1491096e]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-1491096e]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-1491096e]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-1491096e]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-1491096e]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-1491096e]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-1491096e]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-1491096e]{font-size:16px;line-height:24px}}.use-text-caption[data-v-1491096e],.use-text-paragraph[data-v-1491096e]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-1491096e]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-1491096e]{display:none}}@media(max-width:1279px){.use-hidden-md-down[data-v-1491096e]{display:none}}@media(max-width:959px){.use-hidden-sm-down[data-v-1491096e]{display:none}}@media(max-width:599px){.use-hidden-xs-down[data-v-1491096e]{display:none}}@media(min-width:1280px){.use-hidden-lg-up[data-v-1491096e]{display:none}}@media(min-width:960px){.use-hidden-md-up[data-v-1491096e]{display:none}}@media(min-width:600px){.use-hidden-sm-up[data-v-1491096e]{display:none}}.root[data-v-1491096e]{position:relative;padding-bottom:240px;margin:0 auto -320px}.root[data-v-1491096e]:before{opacity:.2;content:\"\";position:absolute;top:0;left:0;width:100%;height:100%}.theme--light .root[data-v-1491096e]:before{background-image:linear-gradient(180deg,#fff 40%,var(--v-primarylight-base) 0)}.theme--dark .root[data-v-1491096e]:before{background-image:linear-gradient(180deg,#303030 40%,var(--v-primarylight-base) 0)}@media(max-width:959px){.root[data-v-1491096e]:before{top:-30px}}.deco-bg-top[data-v-1491096e]{background-repeat:no-repeat;background-color:transparent;background-size:100% auto;transform:scaleY(.4);position:absolute;width:100%;height:600px;top:220px}.theme--light .deco-bg-top[data-v-1491096e]{background-image:url(/images/mobile/deco-light-top.svg)}.theme--dark .deco-bg-top[data-v-1491096e]{background-image:url(/images/mobile/deco-dark-top.svg)}[dir=ltr] .deco-bg-top[data-v-1491096e]{left:0}[dir=rtl] .deco-bg-top[data-v-1491096e]{right:0}@media(max-width:959px){.deco-bg-top[data-v-1491096e]{top:400px}}.parallax-event[data-v-1491096e]{position:absolute;top:-320px;width:100%}[dir=ltr] .parallax-event[data-v-1491096e]{left:0}[dir=rtl] .parallax-event[data-v-1491096e]{right:0}.blog-wrap[data-v-1491096e]{position:relative;z-index:10;margin:80px 0}@media(max-width:599px){.list-news>div[data-v-1491096e]{padding-top:0!important;padding-bottom:0!important}}", ""]);
// Exports
module.exports = exports;
...
var Faq_component = Object(componentNormalizer["a" /* default */])(
  ...
  Faqvue_type_template_id_2e7a8825_scoped_true_render,
  Faqvue_type_template_id_2e7a8825_scoped_true_staticRenderFns,
  false,
  Faq_injectStyles,
  "2e7a8825",
  "3990b83c"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/NewsEvent/NewsEvent.vue?vue&type=template&id=1491096e&scoped=true&
var NewsEventvue_type_template_id_1491096e_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"root"},[_vm._ssrNode("<div class=\"deco-bg-top\" data-v-1491096e></div> "),_vm._ssrNode("<div class=\"parallax-event\" data-v-1491096e>","</div>",[_c('parallax-large')],1),_vm._ssrNode(" "),_c('title-main',{attrs:{"align":"center"}},[_vm._v("\n    "+_vm._s(_vm.$t('mobileLanding.news_title'))+"\n  ")]),_vm._ssrNode(" <p align=\"center\" class=\"use-text-subtitle2\" data-v-1491096e>\n    Our latest news and events will appear here!\n  </p> "),_vm._ssrNode("<div class=\"blog-wrap\" data-v-1491096e>","</div>",[_c('v-container',{staticClass:"fixed-width"},[_c('v-row',{staticClass:"spacing6 list-news"},[_c('v-col',{staticClass:"pa-6",attrs:{"md":"6","cols":"12"}},[_c('news-card',{attrs:{"img":_vm.imgAPI.discount[1],"type":"potrait","caption":"Subscription Discount!","text":"Monthly subscription now Ksh.100. Or Ksh.1000 for a whole year!"}})],1),_vm._v(" "),_c('v-col',{staticClass:"pa-6",attrs:{"md":"6","cols":"12"}},[_c('news-card',{attrs:{"type":_vm.isMobile ? 'potrait' : 'landscape',"img":_vm.imgAPI.photo[1],"caption":"news","text":"No news at the moment!"}}),_vm._v(" "),_c('news-card',{attrs:{"type":_vm.isMobile ? 'potrait' : 'landscape',"img":_vm.imgAPI.photo[2],"caption":"news","text":"No news at the moment!"}})],1)],1)],1)],1)],2)}
var NewsEventvue_type_template_id_1491096e_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./components/NewsEvent/NewsEvent.vue?vue&type=template&id=1491096e&scoped=true&
...
var NewsEvent_component = Object(componentNormalizer["a" /* default */])(
  ...
  NewsEventvue_type_template_id_1491096e_scoped_true_render,
  NewsEventvue_type_template_id_1491096e_scoped_true_staticRenderFns,
  false,
